'''
S.T.E.V.E. Mailer Module
Based on the Mailer module by Ginstrom IT Solutions (GITS)
A software component of S.T.E.V.E. (Super Traversing Enigmatic Voice-commanded Engine)
Device invented by Jacob Turner
Code by GITS; released under the MIT license
'''
...
__version__ = "0.7-1"
__author__ = "Ryan Ginstrom (modifications by Jacob Turner)"
__license__ = "MIT"
