'''
S.T.E.V.E. Speech Interface
Based on speech.py by Michael Gundlach
A software component of S.T.E.V.E. (Super Traversing Enigmatic Voice-commanded Engine)
Device invented by Jacob Turner
Code by Michael Gundlach; released under the Apache 2.0 license (http://www.apache.org/licenses/LICENSE-2.0)
'''
